...
Instructions for the To-Do List Application.
...
Enter 4 if you wish to delete an existing task from the task list.  
Enter 5 if you wish to list all existing tasks that are currently in the list (including tasks marked as complete).  
Enter 6 to exit the program.  
  
Exiting the program will prompt the application to save all task information into the tasks.txt text file for it to be loaded again upon re-running the program.
